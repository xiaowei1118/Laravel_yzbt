              ...
              <div class="widget-content nopadding">
                <form method="post" class="form-horizontal">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="telephone" class="span10" />
                    </div>
                  </div>
                  <div class="control-group">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="period" class="span10" />
                    </div>
                  </div>
                  <div class="control-group">
                    <label class="control-label">开始时间：</label>
                    <div class="controls">
                      <input type="text" name="registration_time" data-date="2016-01-01" data-date-format="yyyy-mm-dd" value="" class="datepicker"/>
                    </div>
                  </div>
                  <div class="control-group">
                    <label class="control-label">结束时间：</label>
                    <div class="controls">
                      <input type="text" name="registration_deadline" data-date="2016-01-01" data-date-format="yyyy-mm-dd" value="" class="datepicker"/>
                    </div>
                  </div>
