...
<!--Header-part-->
<div id="header">
  <h1><a href="#">Shared on www.MafiaShare.net</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i>首 页</a>
  <ul>
    ...
    <li><a href="{{url('/signup')}}"><i class="icon icon-signal"></i><span>报 名 管 理</span></a>
    </li>
    ...
    <li><a href="#"><i class="icon icon-tint"></i><span>专 题 资  讯 管 理</span></a>
      <ul>
        <li><a href="topic-list.php">资 讯 管 理</a></li>
      </ul>
    </li>
    <li><a href="#"><i class="icon icon-pencil"></i><span>系 统 管 理</span></a>
      <ul>
        <li><a href="#">开 通 城 市 管 理</a></li>
        <li><a href="#">摄 影 师 管 理</a></li>
        <li><a href="#">平 台 电 话 设 置</a></li>
        <li><a href="#">关 于 我 们</a></li>
      </ul>
    </li>
  </ul>
</div>
